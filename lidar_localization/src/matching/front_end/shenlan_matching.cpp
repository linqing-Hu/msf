...
bool ShenLanMatching::InitWithConfig() {
  //
...
bool ShenLanMatching::InitFilter(
...
bool ShenLanMatching::InitLocalMapSegmenter(const YAML::Node& config_node) {
  local_map_segmenter_ptr_ = std::make_shared<BoxFilter>(config_node);
  return true;
}

bool ShenLanMatching::InitPointCloudProcessors(const YAML::Node& config_node) {
  // prompt:
...
bool ShenLanMatching::InitGlobalMap(const YAML::Node& config_node) {
...
bool ShenLanMatching::InitRegistration(
    const YAML::Node& config_node,
...
bool ShenLanMatching::InitRelocalization(const YAML::Node& config_node) {
...
bool ShenLanMatching::ResetLocalMap(float x, float y, float z) {
...
bool ShenLanMatching::SetInitPose(const Eigen::Matrix4f& init_pose) {
...
bool ShenLanMatching::Init(const CloudData& init_scan,
...
bool ShenLanMatching::SetGNSSPose(const Eigen::Matrix4f& gnss_pose) {
...
bool ShenLanMatching::SetPoseWithConfig(const CloudData& init_scan) {
...
bool ShenLanMatching::Relocalization(
...
bool ShenLanMatching::Update(const CloudData& cloud_data,
...
// bool ShenLanMatching::HasInited(void) { return has_inited_; }

// bool ShenLanMatching::HasNewGlobalMap(void) { return has_new_global_map_; }

// bool ShenLanMatching::HasNewLocalMap(void) { return has_new_local_map_; }

// Eigen::Matrix4f ShenLanMatching::GetInitPose(void) { return init_pose_; }

// CloudData::CloudTypePtr& ShenLanMatching::GetGlobalMap(void) {
//   has_new_global_map_ = false;
//   return global_map_ptr_;
// }

// CloudData::CloudTypePtr& ShenLanMatching::GetLocalMap(void) { return
// local_map_ptr_;
// }

// CloudData::CloudTypePtr& ShenLanMatching::GetCurrentScan(void) {
