...
void IMUPreIntegrator::ResetState(const IMUData& init_imu_data) {
  ...
  state_.b_a_i = Eigen::Vector3d(init_imu_data.accel_bias_.x,
                                 init_imu_data.accel_bias_.y,
                                 init_imu_data.accel_bias_.z);
  // d. set init bias, gyroscope:
  state_.b_g_i = Eigen::Vector3d(init_imu_data.gyro_bias_.x,
                                 init_imu_data.gyro_bias_.y,
...
void IMUPreIntegrator::CheckJacobian(double T,
                                     Eigen::Vector3d prev_a,
                                     Eigen::Vector3d prev_w,
                                     Eigen::Vector3d curr_a,
                                     Eigen::Vector3d curr_w,
                                     Eigen::Vector3d prev_delta_p,
                                     Sophus::SO3d prev_delta_q,
                                     Eigen::Vector3d prev_delta_v,
                                     Eigen::Vector3d prev_ba,
                                     Eigen::Vector3d prev_bg,
                                     Eigen::Vector3d& curr_delta_p,
                                     Sophus::SO3d& curr_delta_q,
                                     Eigen::Vector3d& curr_delta_v,
