...
void Point2PlaneICP::DetectSurfaceFeaturePair(
    ...
    std::vector<Eigen::Vector3f>& surface_normal) {
#pragma omp parallel num_threads(num_threads_)
  {
    std::vector<std::pair<Eigen::Vector3f, Eigen::Vector3f>>
        feature_pair_private;
    std::vector<Eigen::Vector3f> feature_normal_private;
...
bool Point2PlaneICP::Optimization(
    const std::vector<std::pair<Eigen::Vector3f, Eigen::Vector3f>>&
        surface_feature_pair,
    const std::vector<Eigen::Vector3f>& surface_normal,
    Eigen::Matrix4f& T) {
...
bool Point2PlaneICP::ScanMatch(const CloudData::CloudTypePtr& input_source,
  ...
  std::vector<Eigen::Vector3f> surface_normal;
  std::vector<std::pair<Eigen::Vector3f, Eigen::Vector3f>> surface_feature_pair;
