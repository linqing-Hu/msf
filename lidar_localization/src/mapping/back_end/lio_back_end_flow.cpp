 ...
 * @LastEditTime: 2022-10-03 15:43:42
 */

#include "lidar_localization/mapping/back_end/lio_back_end_flow.h"

namespace lidar_localization {

LIOBackEndFlow::LIOBackEndFlow(ros::NodeHandle& nh,
  ...
  velocity_sub_ptr_ = std::make_shared<VelocitySubscriber>(
      nh, "/kitti/oxts/gps/vel/extract", 1000000);
  ...
  const std::string config_file_path =
      WORK_SPACE_PATH + "/config/mapping/lio_back_end.yaml";
...
bool LIOBackEndFlow::HasData() const {
...
bool LIOBackEndFlow::UpdateIMUPreIntegration() {
...
bool LIOBackEndFlow::UpdateOdoPreIntegration() {
