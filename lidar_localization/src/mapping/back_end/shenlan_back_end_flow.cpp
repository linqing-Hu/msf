/*
 * @Description: LIO mapping backend workflow for shenlan dataset
 * @Author: ZiJieChen
 * @Date: 2022-10-03 15:38:05
 * @LastEditors: ZiJieChen
 * @LastEditTime: 2022-10-31 10:28:19
 */

#include "lidar_localization/mapping/back_end/shenlan_lio_back_end_flow.h"

namespace lidar_localization {

ShenLanLIOBackEndFlow::ShenLanLIOBackEndFlow(ros::NodeHandle& nh,
...
bool ShenLanLIOBackEndFlow::Run() {
...
bool ShenLanLIOBackEndFlow::ForceOptimize() {
...
bool ShenLanLIOBackEndFlow::SaveOptimizedOdometry() {
  back_end_ptr_->SaveOptimizedPose();

  return true;
}

bool ShenLanLIOBackEndFlow::ReadData() {
  // a. lidar scan, key frame measurement:
 ...
 */
bool ShenLanLIOBackEndFlow::InsertLoopClosurePose() {
...
bool ShenLanLIOBackEndFlow::HasData() const {
...
bool ShenLanLIOBackEndFlow::ValidData() {
...
bool ShenLanLIOBackEndFlow::UpdateIMUPreIntegration() {
...
// bool ShenLanLIOBackEndFlow::UpdateOdoPreIntegration() {
...
bool ShenLanLIOBackEndFlow::UpdateBackEnd() {
...
bool ShenLanLIOBackEndFlow::PublishData() {
