 ...
 * @LastEditTime: 2022-09-26 23:11:55
 */
...
bool KITTIFilteringFlow::SaveOdometry() {
  if (0 == trajectory_.N) {
    return false;
  }
...
bool KITTIFilteringFlow::HasInited() const {
...
bool KITTIFilteringFlow::InitLocalization() const {
...
bool KITTIFilteringFlow::PublishGlobalMap() const {
...
bool KITTIFilteringFlow::PublishLocalMap() const {
...
bool KITTIFilteringFlow::PublishLidarOdom() const {
