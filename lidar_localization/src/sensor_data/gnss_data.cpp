...
void GNSSData::UpdateXYZ() {
  ...
  geo_converter_.Forward(
      latitude_, longitude_, altitude_, local_E_, local_N_, local_U_);
}

void GNSSData::Reverse(const double local_E,
...
bool GNSSData::SyncData(const double sync_time,
                        std::deque<GNSSData>& UnsyncedData,
