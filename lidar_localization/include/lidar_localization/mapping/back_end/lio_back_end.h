 ...
 * @LastEditTime: 2022-11-01 22:56:40
 */
#ifndef LIDAR_LOCALIZATION_MAPPING_BACK_END_LIO_BACK_END_H_
#define LIDAR_LOCALIZATION_MAPPING_BACK_END_LIO_BACK_END_H_
...
class LIOBackEnd {
 public:
  LIOBackEnd(const std::string& config_file_path);
...
#endif  // LIDAR_LOCALIZATION_MAPPING_BACK_END_LIO_BACK_END_H_