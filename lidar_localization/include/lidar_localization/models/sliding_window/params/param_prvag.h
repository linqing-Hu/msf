 ...
 * @LastEditTime: 2022-09-20 23:00:55
 */

#ifndef LIDAR_LOCALIZATION_MODELS_SLIDING_WINDOW_PARAM_PRVAG_H_
#define LIDAR_LOCALIZATION_MODELS_SLIDING_WINDOW_PARAM_PRVAG_H_
...
class ParamPRVAG : public ceres::LocalParameterization {
 public:
  ...
  virtual bool Plus(const double* x,
    ...
    pos_plus = pos + d_pos;
    //
    // TODO: evaluate performance penalty of applying exp-exp-log transform for
    // each update
    //
...
#endif  // LIDAR_LOCALIZATION_MODELS_SLIDING_WINDOW_PARAM_PRVAG_H_