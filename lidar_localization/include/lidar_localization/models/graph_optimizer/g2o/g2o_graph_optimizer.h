 ...
 * @LastEditTime: 2022-11-01 22:54:45
 */
#ifndef LIDAR_LOCALIZATION_MODELS_GRAPH_OPTIMIZER_G2O_G2O_GRAPH_OPTIMIZER_H_
#define LIDAR_LOCALIZATION_MODELS_GRAPH_OPTIMIZER_G2O_G2O_GRAPH_OPTIMIZER_H_
...
#include "lidar_localization/models/graph_optimizer/g2o/edge/edge_prvag_prior_body_vel.h"
#include "lidar_localization/models/graph_optimizer/g2o/edge/edge_prvag_prior_pos.h"
#include "lidar_localization/models/graph_optimizer/g2o/edge/edge_prvag_relative_pose.h"
#include "lidar_localization/models/graph_optimizer/g2o/edge/edge_se3_priorquat.h"
#include "lidar_localization/models/graph_optimizer/g2o/edge/edge_se3_priorxyz.h"
...
class G2oGraphOptimizer : public InterfaceGraphOptimizer {
 public:
  ...
  void AddSe3Node(const Eigen::Isometry3d& pose, const bool need_fix) override;
  void AddSe3Edge(const int vertex_index1,
                  const int vertex_index2,
                  const Eigen::Isometry3d& relative_pose,
                  const Eigen::VectorXd& noise) override;
  void AddSe3PriorXYZEdge(const int se3_vertex_index,
                          const Eigen::Vector3d& xyz,
                          const Eigen::VectorXd& noise) override;
  void AddSe3PriorQuaternionEdge(const int se3_vertex_index,
   ...
   * @return true if success false otherwise
   */
  void AddPRVAGNode(const KeyFrame& lio_key_frame, const bool need_fix);
  /**
   ...
   * @return void
   */
  void AddPRVAGRelativePoseEdge(const int vertex_index_i,
   ...
   * @return void
   */
  void AddPRVAGPriorPosEdge(const int vertex_index,
  ...
  void AddPRVAGPriorBodyVelEdge(const int vertex_index,
                                const double vel,
                                const Eigen::VectorXd& noise);
 ...
 private:
  ...
  double robust_kernel_size_{0.0};
