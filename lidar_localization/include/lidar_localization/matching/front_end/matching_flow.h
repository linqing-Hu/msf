 ...
 * @LastEditTime: 2022-09-22 19:53:51
 */
#ifndef LIDAR_LOCALIZATION_MATCHING_FRONT_END_MATCHING_FLOW_H_
#define LIDAR_LOCALIZATION_MATCHING_FRONT_END_MATCHING_FLOW_H_
...
class MatchingFlow {
 public:
  MatchingFlow(const ros::NodeHandle& nh);
...
#endif  // LIDAR_LOCALIZATION_MATCHING_FRONT_END_MATCHING_FLOW_H_