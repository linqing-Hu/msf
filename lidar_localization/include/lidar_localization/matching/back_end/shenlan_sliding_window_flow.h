 ...
 */
#ifndef LIDAR_LOCALIZATION_MATCHING_BACK_END_SHENLAN_SLIDING_WINDOW_FLOW_H_
#define LIDAR_LOCALIZATION_MATCHING_BACK_END_SHENLAN_SLIDING_WINDOW_FLOW_H_
...
class ShenLanSlidingWindowFlow {
 public:
  ShenLanSlidingWindowFlow(const ros::NodeHandle& nh);
...
#endif  // LIDAR_LOCALIZATION_MATCHING_BACK_END_SHENLAN_SLIDING_WINDOW_FLOW_H_