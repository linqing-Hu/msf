 ...
 * @LastEditTime: 2022-11-03 21:33:01
 */
#ifndef LIDAR_LOCALIZATION_FILTERING_SHENLAN_FILTERING_FLOW_H_
#define LIDAR_LOCALIZATION_FILTERING_SHENLAN_FILTERING_FLOW_H_
...
class ShenLanFilteringFlow {
 public:
  ShenLanFilteringFlow(ros::NodeHandle& nh);
  bool Run();
 ...
 private:
  ...
  // filtering instance:
  std::shared_ptr<ShenLanFiltering> filtering_ptr_{};
